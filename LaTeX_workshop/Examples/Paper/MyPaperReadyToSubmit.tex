...
Let's start with a first sentence. And then get some cites to support it \citep{Cooper2008,Brazeau2011,harrisonamong-character2014}. % There are several format for citing, here \citep cites with parenthesis.
